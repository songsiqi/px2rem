...
// should not transform specified properties
var shouldNotTransform = function(property, properties){
    return properties && properties.indexOf(property) !== -1 ;
};
        ...
        for (var i = 0; i < rules.length; i++) {
            ...
            for (var j = 0; j < declarations.length; j++) {
                ...
                if (declaration.type === 'declaration' && pxRegExp.test(declaration.value)) {
                    ...
                    // should not transform specified properties
                    if(shouldNotTransform(declaration.property, config.noTransformProperties)){
                        continue;
                    }
