...
Px2rem.prototype.generateRem = function(cssText) {
    ...
    function processRules(rules) {
        for (var i = 0; i < rules.length; i++) {
            ...
            // the rule for keyframe generated by the css mudule contains values instead of selectors
            // we need the selectors property to get new rules
            if (rule.type === 'keyframe') {
                rule.selectors = rule.values;
            }
